      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
            Sign in to check-in on your emotional wellness
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-sm border border-slate-200 dark:border-slate-700/80 transition-all duration-300">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            {/* Error Message */}
            {error && (
              <div className="flex items-center space-x-2 p-3 rounded-2xl bg-red-50 dark:bg-red-950/40 text-red-600 dark:text-red-400 text-xs font-semibold border border-red-100 dark:border-red-900/40">
